...
public class GoodsServiceTest {
    ...
    public static void saveTest() {
        ...
        GoodsService.getGoodsService().save(new GoodsDTO("name", 20, GroupService.getGroupService().getByName("test").getId()));
        GoodsService.getGoodsService().save(new GoodsDTO("eman", 100, GroupService.getGroupService().getByName("testtest").getId()));
    }
    ...
    public void changeTest(){
        ...
        GoodsService.getGoodsService().changeGroupId(goodsDTO, GroupService.getGroupService().getByName("testtest").getId());
    }
    ...
    public void getListTest(){
        ...
        assert (GoodsService.getGoodsService().getListByGroupId(GroupService.getGroupService().getByName("test").getId()).size() > 0 ||
        GoodsService.getGoodsService().getListByGroupId(GroupService.getGroupService().getByName("testtest").getId()).size() > 0);
    ...
    public void updateTest() {
        ...
        goodsDTO = new GoodsDTO(goodsDTO.getId(), "goods", 60, GroupService.getGroupService().getByName("test").getId());
